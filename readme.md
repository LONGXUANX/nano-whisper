# nano-whisper
nano-whisper is an inference engine that supports cross-attention encoder-decoder model and benchmarking vLLM & CTranslate2(Faster-whisper) with non-redundant code
...
|----------|---------|---------|---------|---------|---------|---------|
| CTranslate2(Faster-whisper) | 0.130/0.130 | -/0.130 | -/0.130 | -/0.130 | -/0.130 | -/0.130 |
